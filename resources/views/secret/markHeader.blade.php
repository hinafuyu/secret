<header id="header">
    <nav class="nav">
        <p class="sitename"><a href="/indexP#header">secret</br>sightseeing</a></p>
        <div class="burger-menu">
            <div class="burger-back"></div>
            <div class="menu">
                <ul>
                    <li><a href="/indexP#slideshow">はじめに</a></li>
                    <li><a href="/indexP#spotTitle">スポット</a></li>
                    <li><a href="{{ route('contact') }}">お問い合わせ</a></li>
                    <li><a href="{{ url('/bookmark') }}">ブックマーク一覧</a></li>
                </ul>
